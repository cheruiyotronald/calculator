          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                calcbutton('%', Colors.grey, Colors.black),
                calcbutton('/', Colors.white, Colors.yellowAccent),
              ],
            ),
            SizedBox(height: 20,),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                calcbutton('7', Colors.black54, Colors.black),
                calcbutton('8', Colors.grey, Colors.black),
                calcbutton('9', Colors.grey, Colors.black),
                calcbutton('x', Colors.grey, Colors.yellowAccent),
              ],
            ),
            SizedBox(height: 20,),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                calcbutton('4', Colors.black54, Colors.black),
                calcbutton('5', Colors.grey, Colors.black),
                calcbutton('6', Colors.grey, Colors.black),
                calcbutton('-', Colors.grey, Colors.yellowAccent),
              ],
            ),
            SizedBox(height: 20,),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                calcbutton('1', Colors.black54, Colors.black),
            ...
            Row(
              ...
              ElevatedButton(
               ...
               calcbutton('=', Colors.amber, Colors.yellow),              
              ],
            ),
            SizedBox(height: 20,),
          ],
